...
{
	public class SpeechToTextIntentContinuousKeywordConversation
	{
        SpeechConfig _config;
        TextToSpeechOnce _talker;

        public SpeechToTextIntentContinuousKeywordConversation()
		{
            ...
            {                
                ...
                using (var recognizer = new IntentRecognizer(_config))
                {
                    ...
                    recognizer.Recognized += async (s, e) =>
                    {
                        ...
                        {
                           await _talker.SpeakTextAsync("Hello there what would you like to do");
                        }
